...
#                               pass
    ...
    def check_convert_usertype(self, usertype):
        ...
        if not (usertype in rbconfig.usertypes or usertype in rbconfig.convert_usertypes):
    ...
    def stats(self):
        ...
        print('%9s' % 'ALL', end=' ')
        for c in categories:
            print("%7d" % category_totals[c], end=' ')
        print()
        print()
